  ...
  <div id="current">
    ...
    <div class="row">
      <div class="col-sm-12">
        <div class="card bg-dark text-white">
          <div class="card-body">
            <h5 class="card-title">Privacy App</h5>
            <p class="card-text">I'm currently working on a website that gives the user a report of their online privacy. You can check it out on Github.</p>
